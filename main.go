...
func init() {
	...
	os.Setenv("APP_CERTIFICATE", "**YOUR APP CERTIFICATE**")
...
func generateRtcToken(channelName, uidStr, tokentype string, role rtctokenbuilder2.Role, expireTimestamp uint32) (rtcToken string, err error) {
	...
	if tokentype == "userAccount" {
		...
		// rtcToken, err = rtctokenbuilder2.BuildTokenWithUserAccount(appID, appCertificate, channelName, uidStr, role, expireTimestamp)
		return rtcToken, err
